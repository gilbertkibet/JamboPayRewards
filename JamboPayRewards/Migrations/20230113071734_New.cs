    ...
    public partial class New : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AmbassadorSupporters",
                columns: table => new
                {
                    Id = table.Column<string>(nullable: false),
                    AmbassadorId = table.Column<string>(nullable: true),
                    SupporterId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmbassadorSupporters", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UtilityId = table.Column<string>(nullable: true),
                    CreatedAt = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Utilities_UtilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_UtilityId",
                table: "Transactions",
                column: "UtilityId");
        }
